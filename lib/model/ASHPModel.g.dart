...
ASHPModel _$ASHPModelFromJson(Map<String, dynamic> json) => ASHPModel(
      ...
      existingRadiatorComments:
          json['existingRadiatorComments'] as String? ?? '',
      ...
      electricalSystemComments:
          json['electricalSystemComments'] as String? ?? '',
...
Map<String, dynamic> _$ASHPModelToJson(ASHPModel instance) => <String, dynamic>{
      ...
      'createdDateTime':  'createdDateTime': instance.createdDateTime==null?DateTime.now().toIso8601String():instance.createdDateTime?.toIso8601String(),
