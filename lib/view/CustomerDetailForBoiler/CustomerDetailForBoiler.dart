...
class CustomerDetailForBoiler extends StatefulWidget {
  ...
  @override
  State<CustomerDetailForBoiler> createState() => _CustomerDetailForBoilerState();
}
           ...
           Padding(
             ...
             child: Column(
               children: [
                 ...
                 SizedBox(height: 5.h,),
                 CustomTextFormFieldWithPrefix2(keyboardType: TextInputType.text,readOnly: false,),
                 SizedBox(height: 20.h,),
                 Row(
                   children: [
                     Text(
                   ...
                   children: [
                     InkWell(
                       ...
                       child: Container(
                         height: 46.h,
                         width: 148,
                         decoration:bool1==1? BoxDecoration(
                     ...
                     InkWell(
                       ...
                       child: Container(
                         height: 46.h,
                         width: 148,
                         decoration:bool1==0? BoxDecoration(
                             borderRadius: BorderRadius.circular(16),
                             color: Color(0xff42FF55)
                         ):BoxDecoration(
                             borderRadius: BorderRadius.circular(16),
                ...
                child: Column(children: [
                 ...
                 InkWell(
                   onTap: (){
                     ...
                     Navigator.push(context, MaterialPageRoute(builder: (context)=>RiskAssesmentForm1(role: role,)));
                   },
                   child: Container(
                     height: 46.h,
                     width: 106,
