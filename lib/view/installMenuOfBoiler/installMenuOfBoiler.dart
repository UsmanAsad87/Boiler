      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            Center(child: Text("Boiler Install",style: GoogleFonts.dmSans(fontSize:27.sp,fontWeight: FontWeight.w500),)),
        ...
        ,SizedBox(height: 30.h,),
                    ...
                    child: Row(
                      ...
                      children: [
                        InkWell(
                          ...
                          height: 35.h,
                          width: 74.w,
                          decoration: yes1==1?BoxDecoration(
                        ...
                        InkWell(
                          ...
                          child: Container(
                            height: 35.h,
                            width: 74.w,
                            decoration:yes1==2? BoxDecoration(
                                borderRadius: BorderRadius.circular(11),
                                color: Color(0xffD9D9D9)
                            ): BoxDecoration(
                                borderRadius: BorderRadius.circular(11),
            ...
            Padding(
              ...
              child: Row(
                mainAxisAlignment: MainAxisAlignment.spaceAround,
                children: [
                  Expanded(child: Text("Boiler Location Correct",style: GoogleFonts.dmSans(fontSize:15.sp,fontWeight: FontWeight.w400),)),
                  Container(
                    width: MediaQuery.of(context).size.width*0.4,
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.spaceAround,
                      ...
                      children: [
                        InkWell(
                          ...
                          height: 35.h,
                          width: 74.w,
                          decoration: yes2==1?BoxDecoration(
                              borderRadius: BorderRadius.circular(11),
                              color: Color(0xffD9D9D9)
                          ):BoxDecoration(
                              borderRadius: BorderRadius.circular(11),
                        ...
                        InkWell(
                          ...
                          child: Container(
                            height: 35.h,
                            width: 74.w,
                            decoration:yes2==2? BoxDecoration(
                                borderRadius: BorderRadius.circular(11),
                                color: Color(0xffD9D9D9)
                            ): BoxDecoration(
                                borderRadius: BorderRadius.circular(11),
                    ...
                    child: Row(
                      ...
                      children: [
                        InkWell(
                          ...
                          height: 35.h,
                          width: 74.w,
                          decoration: yes3==1?BoxDecoration(
                              borderRadius: BorderRadius.circular(11),
                              color: Color(0xffD9D9D9)
                          ):BoxDecoration(
                              borderRadius: BorderRadius.circular(11),
                        ...
                        InkWell(
                          ...
                          child: Container(
                            height: 35.h,
                            width: 74.w,
                            decoration:yes3==2? BoxDecoration(
                                borderRadius: BorderRadius.circular(11),
                                color: Color(0xffD9D9D9)
                            ): BoxDecoration(
                                borderRadius: BorderRadius.circular(11),
            ...
            Padding(
              ...
              child: Row(
                mainAxisAlignment: MainAxisAlignment.spaceAround,
                children: [
                  Expanded(child: Text("Correct Control:",style: GoogleFonts.dmSans(fontSize:15.sp,fontWeight: FontWeight.w400),)),
                  Container(
                    width: MediaQuery.of(context).size.width*0.4,
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.spaceAround,
                      ...
                      children: [
                        InkWell(
                          ...
                          height: 35.h,
                          width: 74.w,
                          decoration: yes4==1?BoxDecoration(
                              borderRadius: BorderRadius.circular(11),
                              color: Color(0xffD9D9D9)
                          ):BoxDecoration(
                              borderRadius: BorderRadius.circular(11),
                        ...
                        InkWell(
                          ...
                          child: Container(
                            height: 35.h,
                            width: 74.w,
                            decoration:yes4==2? BoxDecoration(
                                borderRadius: BorderRadius.circular(11),
                                color: Color(0xffD9D9D9)
                            ): BoxDecoration(
                                borderRadius: BorderRadius.circular(11),
                          ...
                          onTap:()
{
  setState(() {
    ...
    yes=1;
                            ...
                            height: 35.h,
                            width: 74.w,
                            decoration: yes==1?BoxDecoration(
                                borderRadius: BorderRadius.circular(11),
                                color: Color(0xffD9D9D9)
                            ):BoxDecoration(
                                borderRadius: BorderRadius.circular(11),
...
;                            });
                          ...
                          child: Container(
                            height: 35.h,
                            width: 74.w,
                            decoration:yes==2? BoxDecoration(
                                borderRadius: BorderRadius.circular(11),
                                color: Color(0xffD9D9D9)
                            ): BoxDecoration(
                                borderRadius: BorderRadius.circular(11),
            ...
            Padding(
              ...
              child: Row(
                mainAxisAlignment: MainAxisAlignment.spaceAround,
                children: [
                  Expanded(child: Text("Flue Route /Location / Termination Agreed",style: GoogleFonts.dmSans(fontSize:15.sp,fontWeight: FontWeight.w400),)),
                  Container(
                    width: MediaQuery.of(context).size.width*0.4,
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.spaceAround,
                      ...
                      children: [
                        InkWell(
                          ...
                          height: 35.h,
                          width: 74.w,
                          decoration: yes7==1?BoxDecoration(
                              borderRadius: BorderRadius.circular(11),
                              color: Color(0xffD9D9D9)
                          ):BoxDecoration(
                              borderRadius: BorderRadius.circular(11),
                        ...
                        InkWell(
                          ...
                          child: Container(
                            height: 35.h,
                            width: 74.w,
                            decoration:yes7==2? BoxDecoration(
                                borderRadius: BorderRadius.circular(11),
                                color: Color(0xffD9D9D9)
                            ): BoxDecoration(
                                borderRadius: BorderRadius.circular(11),
                    ...
                    child: Row(
                      ...
                      children: [
                        InkWell(
                          ...
                          height: 35.h,
                          width: 74.w,
                          decoration: yes6==1?BoxDecoration(
                              borderRadius: BorderRadius.circular(11),
                              color: Color(0xffD9D9D9)
                          ):BoxDecoration(
                              borderRadius: BorderRadius.circular(11),
                        ...
                        InkWell(
                          ...
                          child: Container(
                            height: 35.h,
                            width: 74.w,
                            decoration:yes6==2? BoxDecoration(
                                borderRadius: BorderRadius.circular(11),
                                color: Color(0xffD9D9D9)
                            ): BoxDecoration(
                                borderRadius: BorderRadius.circular(11),
            ...
            Padding(
              ...
              child: Center(child: Text("Please ensure that all points listed above have been thoroughly explained to the customer and correspond with the technical survey in advanceof starting any works. If there are any points which you or the customer have any issues with, please liaise with Head Office immediately.",textAlign: TextAlign.center,style: GoogleFonts.dmSans(fontSize:12.sp,fontWeight: FontWeight.w500),)),
            ),
            SizedBox(height: 30.h,),
            Divider(thickness: 1,color: Colors.black,),
            SizedBox(height: 20.h,),
            ...
            Row(
              children: [
                Padding(
                  padding: const EdgeInsets.symmetric(horizontal: 18.0),
                  child: Text("Has the system been flushed? and with what?",style: GoogleFonts.dmSans(fontSize:15.sp,fontWeight: FontWeight.w400),),
                ),
              ],
            ),
            SizedBox(height: 20.h,),
              ...
              children: [
                InkWell(
                  ...
                  child: Container(
                    height: 33.h,
                    width: 158.w,
                    decoration:systemflushed==0? BoxDecoration(
                        borderRadius: BorderRadius.circular(11),
          ...
          color: Colors.white
                ...
                InkWell(
                  ...
                  child: Container(
                    height: 33.h,
                    width: 158.w,
                    decoration:systemflushed==1? BoxDecoration(
                        borderRadius: BorderRadius.circular(11),
                        color: Color(0xff42FF55)
                    ):BoxDecoration(
                      borderRadius: BorderRadius.circular(11),
            ...
            Visibility(
                ...
                child: CustomTextFormFieldWithPrefix4(readOnly: false,keyboardType: TextInputType.text)),
            ...
            Row(
              children: [
                Padding(
                  padding: const EdgeInsets.symmetric(horizontal: 18.0),
                  child: Text("Did you Install Controls?",style: GoogleFonts.dmSans(fontSize:15.sp,fontWeight: FontWeight.w400),),
                ),
              ],
            ),
            SizedBox(height: 20.h,),
              ...
              children: [
                InkWell(
                  ...
                  child: Container(
                    height: 33.h,
                    width: 158.w,
                    decoration:controls==0? BoxDecoration(
                        borderRadius: BorderRadius.circular(11),
                        color: Color(0xff42FF55)
                    ):BoxDecoration(
                        borderRadius: BorderRadius.circular(11),
                ...
                InkWell(
                  ...
                  child: Container(
                    height: 33.h,
                    width: 158.w,
                    decoration:controls==1? BoxDecoration(
                        borderRadius: BorderRadius.circular(11),
                        color: Color(0xff42FF55)
                    ):BoxDecoration(
                        borderRadius: BorderRadius.circular(11),
