...
import 'package:boiler/view/installMenuOfBoiler/InstallMenuOfBoilercontroller.dart';
...
class _InstallMenuOfBoilerState extends State<InstallMenuOfBoiler> {
  ...
  InstallMenuOfBoilerController _controoler =
      new InstallMenuOfBoilerController();
  @override
          ...
          child: Column(
            children: [
              ...
              CustomTextFormFieldWithPrefix4(
                  ...
                  controller: _controoler.companynamecontroller,
                  readOnly: false,
              ...
              CustomTextFormFieldWithPrefix4(
                  ...
                  controller: _controoler.installercontroller,
                  readOnly: false,
                  keyboardType: TextInputType.text),
              SizedBox(
                height: 15.h,
              ...
              Padding(
                ...
                child: TextFormField(
                  ...
                  controller: _controoler.orginaljobdiscriptioncontroller,
                  maxLines: 5,
                  decoration: InputDecoration(
                      filled: true,
                      fillColor: Colors.white,
              ...
              Padding(
                ...
                child: TextFormField(
                  ...
                  controller: _controoler.proposedvariationcontroller,
                  maxLines: 5,
                  decoration: InputDecoration(
                      filled: true,
                      fillColor: Colors.white,
                ...
                onTap: () {
                  ...
                  if (formkey.currentState!.validate()) {
                    ...
                    FirebaseFirestore.instance
                        .collection('userInfo')
                        .doc(uid)
                        .collection('installMenuBoiler')
                        .doc()
                        .set({
                      'companyEmail': _controoler.companynamecontroller.text,
                      'address': _controoler.addresscontroller.text,
                      'postcode': _controoler.postcodecontroller.text,
                      'installer': _controoler.installercontroller.text,
                      'installerDate': _date.text,
                      'preInstallCheck': yes1 == 1 ? 'true' : 'false',
                      'boilerLocationCorrect': yes2 == 1 ? 'true' : 'false',
                      'allPipeRouteAgreed': yes3 == 1 ? 'true' : 'false',
                      'correctControl': yes4 == 1 ? 'true' : 'false',
                      'radiator': yes5 == 1 ? 'true' : 'false',
                      'flueRoute': yes6 == 1 ? 'true' : 'false',
                      'CostumerWalked': yes7 == 1 ? 'true' : 'false',
                      'originalJobDesc':
                          _controoler.orginaljobdiscriptioncontroller.text,
                      'proposedVariation':
                          _controoler.proposedvariationcontroller.text,
                      'costumerSignature':
                          _controller.isEmpty ? 'null' : _controller.toString(),
                      'dateDeclaration': _date1.text,
                      'installerSignature': _controller1.isEmpty
                          ? 'null'
                          : _controller1.toString(),
                      'date': _date2.text,
                      'ds': widget.ds,
                    }).whenComplete(() {
                      Navigator.push(
