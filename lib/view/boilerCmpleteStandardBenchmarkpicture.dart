...
class BoilerCompleteStandardBenchMarkPicture extends StatefulWidget {
  const BoilerCompleteStandardBenchMarkPicture({Key? key}) : super(key: key);

  @override
  State<BoilerCompleteStandardBenchMarkPicture> createState() => _BoilerCompleteStandardBenchMarkPictureState();
}

class _BoilerCompleteStandardBenchMarkPictureState extends State<BoilerCompleteStandardBenchMarkPicture> {
  File? _image;
  @override
