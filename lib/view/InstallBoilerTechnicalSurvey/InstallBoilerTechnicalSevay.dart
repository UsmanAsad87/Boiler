...
class InstallBoilerTechnicalSevay extends StatelessWidget {
        ...
        body: SingleChildScrollView(
          child: Column(
            children: [
              ...
              SizedBox(height: 20.h,),
              Center(child: Text("Survey Detail",style: GoogleFonts.dmSans(fontSize:27.sp,fontWeight: FontWeight.w500),)),
              ...
              Row(
                children: [
                  Padding(
                    padding: const EdgeInsets.symmetric(horizontal: 18.0),
                    child: Text("Fuel Type:",style: GoogleFonts.dmSans(fontSize:15.sp,fontWeight: FontWeight.w400),),
                  ),
                ],
              ),
              SizedBox(height: 10.h,),
              ...
              InkWell(
                 onTap: (){Navigator.push(context, MaterialPageRoute(builder: (context)=>ExistingBoilerSystemDetails()));},
                child: Container(
                  height: 46.h,
                  width: 193.w,
                  decoration: BoxDecoration(
