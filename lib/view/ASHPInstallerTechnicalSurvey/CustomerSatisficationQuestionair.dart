...
class CustomerSatisficationQuestionair extends StatefulWidget {

  @override
  State<CustomerSatisficationQuestionair> createState() => _CustomerSatisficationQuestionairState();
}

class _CustomerSatisficationQuestionairState extends State<CustomerSatisficationQuestionair> {
            ...
            InkWell(
              onTap: () {
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => HeatPumpHandoverCertificate()));
              },
              child: Container(
                height: 46.h,
                width: 193.w,
