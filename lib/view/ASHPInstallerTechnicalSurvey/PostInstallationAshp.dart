...
class PostInstallationAshp extends StatefulWidget {
  const PostInstallationAshp({Key? key}) : super(key: key);

  @override
  State<PostInstallationAshp> createState() => _PostInstallationAshpState();
}

class _PostInstallationAshpState extends State<PostInstallationAshp> {
              ...
              InkWell(
                onTap: () {
                  Navigator.push(
                      ...
                      MaterialPageRoute(
                          builder:
                              (context) => // onTap: (){Navigator.push(context, MaterialPageRoute(builder: (context)=>CustomerSatisficationQuestionair()));},
