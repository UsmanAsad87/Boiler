...
class CompleteBoilerBenchMark extends StatefulWidget {
  @override
  State<CompleteBoilerBenchMark> createState() => _CompleteBoilerBenchMarkState();
}
                  ...
                  child: Row(
                    ...
                    children: [
                      InkWell(
                          ...
                          child: Text(
                            "Upload Pic",
                            style:show==0? GoogleFonts.dmSans(
                                fontWeight: FontWeight.w400, fontSize: 14,color: Colors.green):GoogleFonts.dmSans(
                      ...
                      InkWell(
                        ...
                        child: Text(
                          "Fill Form",
                          style:show==1? GoogleFonts.dmSans(
                              fontWeight: FontWeight.w400, fontSize: 14,color: Colors.green):GoogleFonts.dmSans(
                              fontWeight: FontWeight.w400, fontSize: 14),
                        ),
                      ),
               ...
               InkWell(
                 onTap: () {
                   Navigator.push(context,
                       MaterialPageRoute(builder: (context) => WaterQuality()));
                 },
                 child: Container(
                   height: 46.h,
                   width: 193.w,
